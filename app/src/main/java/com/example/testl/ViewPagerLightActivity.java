		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				synchronized (list) {
						...
						adapter.notifyDataSetChanged();
						dbin.writeAgreement(CmdPackage.setD1Control(bean.getBrightness(), bean.getColorYellow()));
						dbin.setBrightness(bean.getBrightness());
						dbin.setColorYellow(bean.getColorYellow());
...
//						// TODO Auto-generated method stub
//						try {
//							Thread.sleep(AppConstants.delaySeekTime);
...
//							 iv_switch.setSelected(dbin.isOnOff());
	...
	private void sendD1Control() {
		...
		Log.v("tag",dbin.getDeviceAddress()+ " bright： " + brightness + " color:" + color + " " +sb_color.getMax());
		dbin.writeAgreement(CmdPackage.setD1Control(sb_brightness.getProgress(), sb_color.getProgress()));
		dbin.setBrightness(sb_brightness.getProgress());
