...
public class ViewPagerLightActivity extends BaseActivity {
    ...
    private void initData() {
        tv_brightness.setText(getString(R.string.brightness) + " " + dbin.getBrightnessPrecent() + "%");
        tv_color.setText(getString(R.string.color) + " " + dbin.getColorYellowPrecent() + "%");
                ...
                switch (msg.what) {
                    ...
                    case handler_status:
                        tv_brightness.setText(
                                getString(R.string.brightness) + " " + dbin.getBrightnessPrecent() + "%");
                        tv_color.setText(
                                getString(R.string.color) + " " + dbin.getColorYellowPrecent() + "%");
                        iv_switch.setSelected(dbin.isOnOff());
                        break;
